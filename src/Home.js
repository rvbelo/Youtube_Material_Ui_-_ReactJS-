...
import { makeStyles, AppBar, Toolbar, IconButton, Typography, Button, List, Divider, Drawer, ListItem, ListItemIcon, ListItemText, Box, Grid, ListSubheader, Hidden, Switch, } from '@material-ui/core';
...
function Home({darkMode, setDarkMode}) {
  ...
  <div className={classes.root}>
    ...
    <Box p={3}>
      <Toolbar/>
      <Typography variant='5' color='textPrimary' style={{fontWeight: 600}}>
      Recomendados
      </Typography>
